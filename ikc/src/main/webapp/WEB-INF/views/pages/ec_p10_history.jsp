...
<body id="page-shop" class="style-lang-en">
			...
			<div class="header-inner">
				<div class="logo">
					<a href="/ec_p1_main.html"><img class="img-fluid"
						style="width: 150px;" src="logo2.png" alt=""></a>
				</div>
									...
									<li class="my-3">
										<div style="padding: 10px 30px">
											<a class="btn btn-outline-primary w-100"
												style="font-size: 16px;" href="/ec_p1_main.html" title="登出">登出</a>
										</div>
									</li>
								</ol>
							</div></li>
								...
								<div class="order-block">
									...
									<div class="my-3">
										<div class="float-left py-1">
											<i class="icon-wrap icon-order-number"></i> <span>訂單編號：${row.orderID}</span>
										</div>
										<div class="clearfix"></div>
										<div class="float-left py-1">
											<i class="icon-wrap icon-order-number"></i> <span> <a
												href="https://eservice.7-11.com.tw/e-tracking/search.aspx"
												target="_blank"> 包裹編號 : 82631009242 7-11超商取貨
													[7-Eleven店配] </a>
											</span>
										</div>
										<div class="clearfix"></div>
									...
									<table class="table table-style table-bordered">
										...
										<tbody>
											<tr>
												<td class="nowrap">
													<div class="nowrap">${row.ordertime}</div>
												</td>
									...
									<ul class="product-des-list list-collsape">
										...
										<a data-toggle="collapse" href="#collapseDescription"
											...
											aria-controls="collapseDescription" class="collapsed"><span
											class="text-en" style="font-size: 18px; font-weight: bold;"
											id="myorder">＋ 訂單明細</span></a>
												...
												<div class="mb-2">
													...
													<div class="" id="order-detail1">
															...
															<div class="mb-3">
																<div class="float-left py-1">
																	<i class="icon-wrap icon-check"></i><span
																		class="font-w7">訂單: <span>${row.delivery}</span></span>
																</div>
																...
																<table
																	...
																	<tr>
																		<td class="text-left"><a
																			href="ec_p2_product.html"> <span
																				style="font-size: 17px; text-align: right;">
																					California Gold Nutrition, 金 C 粉，維生素 C，1,000 毫克，240
																					粒素食膠囊</span>
																		</a> <br> <span>【歡慶開幕 全館免運優惠中】</span></td>
														...
														<div class="item-font">
															...
															<a class="qa-ask-block d-block py-4 lh-15"> <i
																class="icon-qa float-left mr-3"></i>
																<div class="qa-text float-left">
																	<div>對訂單有任何問題？</div>
																	<div>歡迎來信 service@ikcare.com，我們在此協助您</div>
				...
				<div class="col-lg-3 col-md-6 mb-4">
					...
					<ul class="list-unstyled mb-0" style="font-size: 16px;">
						...
						<li class="mb-1"><a href="#!"><img
								src="facebook_logos_PNG19753.png" type="button" width="30px"></a>
							<!-- </li>
                        <li class="mb-1"> --> <a href="#!"><img
								src="instagram.png" type="button" width="30px"></a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="https://static.tpx.tw/sff/mouggan/js/orderDetail.js?V=20220512v1"></script>
	<!-- script -->
